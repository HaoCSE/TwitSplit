...
class CircleImageView : AppCompatImageView, ILoadingImageView {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        ...
        mDisableCircularTransformation = a.getBoolean(R.styleable.JavaCircelImageView_j_disable_circular, DEFAULT_DISABLE_CIRCULAR)
        mSquareFollowHeight = a.getBoolean(R.styleable.JavaCircelImageView_jciv_follow_height, DEFAULT_SQUARE_FOLLOW_HEIGHT)
